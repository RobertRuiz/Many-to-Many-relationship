...
class TermsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post terms_url, params: { term: { author: @term.author, definition: @term.definition, name: @term.name, web_link: @term.web_link } }
    end
  ...
  test "should update term" do
    patch term_url(@term), params: { term: { author: @term.author, definition: @term.definition, name: @term.name, web_link: @term.web_link } }
